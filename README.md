...
|---|---|---|
|_"Boise, ID is fun!"_|PlaceGeocoder| <pre>geo = { matchtext:"Boise ID", adm1:"US.16", <br>lat,lon: [43.61,-116.20], feat_code:"PPL", <br>confidence=78}</pre>And associated rules for the location resolution
|_"Born on 30 DECIEMBRE 1990 ... "_ |XTemporal  | <pre>date = { matchtext="30 DECIEMBRE 1990", <br>date_norm="1990-12-30"}	</pre> 
|_"Epicenter at 01°44'N 101°22'E ..."_  |  XCoord | <pre>coord = { matchtext="01°44'N 101°22'E", <br>lat=1.733, lon=101.367, pattern="DM-01"}</pre>

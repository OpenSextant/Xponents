...
Use Xponents SDK to lookup things that appear to be place names.
================================
 
Demo capability here is a demonstration of the APIs and techniques that support 
...
```
* Run the Solr server,  `cd ./solr; mysolr.sh start 7000 `


* Run the demo script, `./script/gazetteer.py`

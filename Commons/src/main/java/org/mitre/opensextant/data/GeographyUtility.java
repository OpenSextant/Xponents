...
public class GeographyUtility {
     ...
     *   US.44  or US.00  gives you 44 or 00 for id part.
     *      In this case upper case code is returned.
     *   if code is a number alone,   "0" is returned for "00", "000", etc.
     *      And other numbers are 0-padded  as 2-digits 
     * @param v
     * @return  
     */
     ...
     * 
     * Usage: 
     *     Savannah is a great city.  Georgia is lucky it has 10 Chic-fil-a restraunts
     *    in that metro area.
     * 
     * Georgia is not a country, but a US State.   So the logic caller might take:
     *    If "savannah" is found, then
     *       ignore georgia("GG") as a possible country 
     * 
     * isCountryNameCollision -- is intending to be objective.  
     * If you choose to ignore the country or not is up to caller.
     * Hence this function is not "ignoreCountry(placenm)"
     * 

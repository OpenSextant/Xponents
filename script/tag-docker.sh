...
if [ -n "$IMG_VERSION" ] ; then
   docker tag opensextant:xponents-$IMG_VERSION  $REPO/opensextant:xponents-$IMG_VERSION
   docker tag opensextant:xponents-$IMG_VERSION  $REPO/opensextant:xponents-$IMG_TARGET

   docker tag opensextant:xponents-offline-$IMG_VERSION  $REPO/opensextant:xponents-offline-$IMG_VERSION

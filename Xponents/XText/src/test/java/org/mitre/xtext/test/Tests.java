...
public class Tests {
    ...
    /**  Test the uncaching of content.
     *   Account for any unknown exception -- Unicode File names is not well-understood.
     *   LANG=en_US  env allows Java to read in file names with unicode chars.
     * .... otherwise this is an undetectable situation and File(unicode_filename).exists() throws bad error.
     */

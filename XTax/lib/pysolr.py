...
class Solr(object):
    ...
    def add(self, docs, sanitize=True, commit=True, boost=None, commitWithin=None, waitFlush=None, waitSearcher=None):
        ...
        response = self._update(m, clean_ctrl_chars=sanitize, commit=commit, waitFlush=waitFlush, waitSearcher=waitSearcher)

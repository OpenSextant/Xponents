...
public interface CrawlFilter {
     ...
     */
    public abstract boolean isAllowCurrentDirOnly();
     ...
     */
    public abstract void setAllowCurrentDirOnly(boolean allowCurrentDirOnly);
     ...
     */
    public abstract boolean isAllowCurrentSiteOnly();

    /**
     * @param allowCurrentSiteOnly the allowCurrentSiteOnly to set
     */
    public abstract void setAllowCurrentSiteOnly(boolean allowCurrentSiteOnly);

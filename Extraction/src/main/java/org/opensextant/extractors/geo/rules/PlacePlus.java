...
import org.opensextant.data.PlaceName;
 ...
 * have other metadata such as Country and Province, so those object pointers
 * are offered here. This keeps the very basic Place parent class as light as
 * can be for the most general uses.
 *
 * Still in incubation.
 *
 * @author ubaldino
 */
public class PlacePlus extends Place {
    ...
    public PlacePlus(String id, String name) {
        super(id, name);
    }
    ...
    public void setProvince(Place p) {
        province = p;
    }

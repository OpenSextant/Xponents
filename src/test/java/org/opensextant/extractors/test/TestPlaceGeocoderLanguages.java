...
public class TestPlaceGeocoderLanguages extends TestPlaceGeocoder {
    ...
    public void tagEvaluation() throws IOException {
        ...
        String[] textsMiddleEastScripts = {
                ...
                /* ASCII/ENG + ARABIC */
                "Hosp here عيادة بدر",
                /* URDU.  Excerpt source is BBC Urdu service 
                 *   Google Translate: 
                 *   "After the announcement of Pakistan's 16-member team for the Asia Cup cricket tournament, 
                 *   the practice of the national cricket team in Lahore's Gaddafi Stadium continues."
                 */
                ...
                /* Farsi. Except source is BBC Farsi service
                *  Google Translate: 
        ...
        String[] textsCJK = { "冀州市冀州镇刘家埝小学-河北省衡水冀州冀州市冀州镇刘家埝小学.", // google search, yields baike.com         
                ...
                /*
                 * Source:https://www.sponichi.co.jp/sports/news/2018/09/10/kiji/20180910s00028000088000c.html
                 * Google Translate: 
                 *  "Haitian American father and Japanese mother born in Hokkaido, I migrated from Osaka to the United States 
                 *  at the age of 3 and entered tennis, I am playing as Japan national team to speak English better than Japanese. 
                 *  Not only the inner gap between on and off but also the gap and complexity of cultural background is in Osaka" 
                 */

 ...
 * gazetteer
 * as well as known properties of specific feature types that make them more or
 * less likely to
 ...
 * name, this provides
 * no tie breaker. "Boston", OH (P/PPL) ~ "Boston", MA (P/PPL) -- feature stats
 * are the same.
...
public class FeatureRule extends GeocodeRule {
    ...
    private static FeatureClassMeta[] fcmeta = { new FeatureClassMeta("P", 9000000, 1.0),
            new FeatureClassMeta("A", 700000, 5.0), new FeatureClassMeta("S", 2700000, 0.8),
            new FeatureClassMeta("T", 2300000, 0.8), new FeatureClassMeta("L", 700000, 0.8),
            new FeatureClassMeta("V", 85000, 0.8), new FeatureClassMeta("R", 65000, 0.7),
            new FeatureClassMeta("U", 12000, 0.5), new FeatureClassMeta("H", 3200000, 0.7),
            new FeatureClassMeta("H/STM", 1600000, 0.3), new FeatureClassMeta("H/RSV", 100000, 0.3),
            new FeatureClassMeta("H/SPNG", 100000, 0.3), new FeatureClassMeta("H/WLL", 100000, 0.3) };
